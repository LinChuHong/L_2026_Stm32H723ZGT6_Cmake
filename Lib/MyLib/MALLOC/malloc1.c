...
// static __align(64) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__(".sdran");     /* 外部SDRAM内存池,前面4MB用做RGB LCD屏的显存(1280*800*4) */
...
/* 内部 SRAM (AXI SRAM 0x24000000) */
static uint8_t mem1base[MEM1_MAX_SIZE]
__attribute__((aligned(64)));

/* 外部 SDRAM */
static uint8_t mem2base[MEM2_MAX_SIZE]
__attribute__((aligned(64), section(".mySDRAM_Section")));

/* DTCM (0x20000000) */
static uint8_t mem3base[MEM3_MAX_SIZE]
__attribute__((aligned(64), section(".DTCMRAM_Section")));

/* ITCM (0x00000000) */
static uint8_t mem4base[MEM4_MAX_SIZE]
__attribute__((aligned(64), section(".ITCMRAM_Section")));
...
__attribute__((section(".mySDRAM_Section")));

/* DTCM */
static MT_TYPE mem3mapbase[MEM3_ALLOC_TABLE_SIZE]
__attribute__((section(".DTCMRAM_Section")));

/* ITCM */
static MT_TYPE mem4mapbase[MEM4_ALLOC_TABLE_SIZE]
__attribute__((section(".ITCMRAM_Section")));
/* 内存管理参数 */
