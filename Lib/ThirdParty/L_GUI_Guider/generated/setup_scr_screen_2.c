...
void setup_scr_screen_2(lv_ui *ui)
{
...
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_2_btn_2
    ui->screen_2_btn_2 = lv_button_create(ui->screen_2);
    lv_obj_set_pos(ui->screen_2_btn_2, 955, 448);
    lv_obj_set_size(ui->screen_2_btn_2, 72, 151);
    ui->screen_2_btn_2_label = lv_label_create(ui->screen_2_btn_2);
    lv_label_set_text(ui->screen_2_btn_2_label, "To_Screen_3");
    lv_label_set_long_mode(ui->screen_2_btn_2_label, LV_LABEL_LONG_SCROLL_CIRCULAR);
...
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_2_btn_2, 247, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_2_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_2_btn_2, lv_color_hex(0x4146d4), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_2_btn_1, 0, 0);
    lv_obj_set_size(ui->screen_2_btn_1, 72, 151);
    ui->screen_2_btn_1_label = lv_label_create(ui->screen_2_btn_1);
    lv_label_set_text(ui->screen_2_btn_1_label, "To_Screen_1\n");
...
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_2_btn_1, 247, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_2_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_2_btn_1, lv_color_hex(0x4146d4), LV_PART_MAIN|LV_STATE_DEFAULT);
