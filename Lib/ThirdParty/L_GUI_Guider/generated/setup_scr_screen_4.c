...
void setup_scr_screen_4(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_4, 1024, 600);
    ...
    lv_obj_set_style_bg_image_src(ui->screen_4, "C:/Users/linchuhong/Desktop/L_2026_Stm32H723ZGT6_Cmake/Lib/ThirdParty/L_GUI_Guider/import/image/Shinobu3.jpeg", LV_PART_MAIN|LV_STATE_DEFAULT);
#else
    lv_obj_set_style_bg_image_src(ui->screen_4, "F:/Shinobu3.bin", LV_PART_MAIN|LV_STATE_DEFAULT);
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_4_btn_1
    ui->screen_4_btn_1 = lv_button_create(ui->screen_4);
    lv_obj_set_pos(ui->screen_4_btn_1, 0, 0);
    lv_obj_set_size(ui->screen_4_btn_1, 132, 66);
    ui->screen_4_btn_1_label = lv_label_create(ui->screen_4_btn_1);
    lv_label_set_text(ui->screen_4_btn_1_label, "To_Screen_5");
    lv_label_set_long_mode(ui->screen_4_btn_1_label, LV_LABEL_LONG_SCROLL_CIRCULAR);
...
#if LV_USE_GUIDER_SIMULATOR
    lv_obj_set_style_bg_image_src(ui->screen_4_btn_1, "C:/Users/linchuhong/Desktop/L_2026_Stm32H723ZGT6_Cmake/Lib/ThirdParty/L_GUI_Guider/import/image/tamayo_and_shinobu.jpg", LV_PART_MAIN|LV_STATE_DEFAULT);
#else
    lv_obj_set_style_bg_image_src(ui->screen_4_btn_1, "F:/tamayo_and_shinobu.bin", LV_PART_MAIN|LV_STATE_DEFAULT);
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_4_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_4_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_4_btn_1, lv_color_hex(0x2fda64), LV_PART_MAIN|LV_STATE_DEFAULT);
