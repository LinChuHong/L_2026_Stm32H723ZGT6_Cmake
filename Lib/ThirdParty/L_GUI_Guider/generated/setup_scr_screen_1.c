...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_image_src(ui->screen_1, "F:\\projects\\CSEE\\L_2025_Stm32H723ZGT6_Cmake\\Lib\\ThirdParty\\L_GUI_Guider\\import\\image\\Clannad.jpeg", LV_PART_MAIN|LV_STATE_DEFAULT);
#else
    lv_obj_set_style_bg_image_src(ui->screen_1, "F:/Clannad.bin", LV_PART_MAIN|LV_STATE_DEFAULT);
#endif
    ...
    lv_obj_set_size(ui->screen_1_btn_1, 72, 151);
    ui->screen_1_btn_1_label = lv_label_create(ui->screen_1_btn_1);
    lv_label_set_text(ui->screen_1_btn_1_label, "To_Main_Screen\n");
...
#if LV_USE_GUIDER_SIMULATOR
    lv_obj_set_style_bg_image_src(ui->screen_1_btn_1, "F:\\projects\\CSEE\\L_2025_Stm32H723ZGT6_Cmake\\Lib\\ThirdParty\\L_GUI_Guider\\import\\image\\Frieren_anime_profile.jpeg", LV_PART_MAIN|LV_STATE_DEFAULT);
#else
    lv_obj_set_style_bg_image_src(ui->screen_1_btn_1, "F:/Frieren_anime_profile.bin", LV_PART_MAIN|LV_STATE_DEFAULT);
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_1_btn_1, 247, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_1_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_btn_1, lv_color_hex(0x4146d4), LV_PART_MAIN|LV_STATE_DEFAULT);
