...
void setup_scr_screen_6(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_6, 1024, 600);
...
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_6_btn_1
    ui->screen_6_btn_1 = lv_button_create(ui->screen_6);
    lv_obj_set_pos(ui->screen_6_btn_1, 0, 0);
    lv_obj_set_size(ui->screen_6_btn_1, 132, 66);
    ui->screen_6_btn_1_label = lv_label_create(ui->screen_6_btn_1);
    lv_label_set_text(ui->screen_6_btn_1_label, "To_Screen_1");
    lv_label_set_long_mode(ui->screen_6_btn_1_label, LV_LABEL_LONG_SCROLL_CIRCULAR);
...
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_6_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_6_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_6_btn_1, lv_color_hex(0x2fda64), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_6_btn_2, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
...
#endif
    lv_obj_set_style_bg_image_opa(ui->screen_6_btn_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_recolor_opa(ui->screen_6_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_6_btn_2, lv_color_hex(0x2fda64), LV_PART_MAIN|LV_STATE_DEFAULT);
